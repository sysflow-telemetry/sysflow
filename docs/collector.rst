...
`libSysFlow <https://sysflow.readthedocs.io/en/dev/libs.html>`_, a library
that lifts system call information into SysFlow, a higher order object relational format that
models how containers, processes and files interact with their environment through process
control flow, file, and network operations. Learn more about SysFlow in the SysFlow Specification
Document.
